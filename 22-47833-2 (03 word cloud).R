...
data <- read_csv("D:/AIUB LECTURE/Data Science/dhakaTribune_articles_with_text.csv", show_col_types = FALSE)
...
png("D:/AIUB LECTURE/Data Science/wordcloud.png", width = 1000, height = 800)
...
cat("✅ Word cloud saved to DD:/AIUB LECTURE/Data Science/ordcloud.png\n")
